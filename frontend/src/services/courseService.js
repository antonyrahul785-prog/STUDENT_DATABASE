...
export const courseService = {
  ...
  updateBatch: async (courseId, batchId, batchData) => {
    return await api.put(`/courses/${courseId}/batches/${batchId}`, batchData);
  },

  deleteBatch: async (courseId, batchId) => {
    return await api.delete(`/courses/${courseId}/batches/${batchId}`);
  }
};